...
module.exports = function(config) {
  ...
  Object.keys(pyradmin.config.models).forEach(function(model) {
    ...
    pyradmin.serverInstance.del(pyradmin.config.basePath + '/' + modelName + '/:modelId', pyradmin.config.authMiddleware, modelIdDel(pyradmin.config.models[model]));
  });
  return pyradmin;
};
